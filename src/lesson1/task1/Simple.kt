 ...
 */
fun lengthInMeters(sagenes: Int, arshins: Int, vershoks: Int): Double = (sagenes * 48 + 48 / 3.0 * arshins + vershoks) * 4.445 / 100.0
 ...
 */
fun travelMinutes(hoursDepart: Int, minutesDepart: Int, hoursArrive: Int, minutesArrive: Int): Int = if (hoursArrive < hoursDepart) {
 ...
 */
fun accountInThreeYears(initial: Int, percent: Int): Double = for (i in 1 .. 3) initial * (1 + percent / 100)
